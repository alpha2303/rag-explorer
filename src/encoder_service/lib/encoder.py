...
class EncoderService:
    def __init__(self, vector_db_manager: BaseVDBManager, text_chunker: TextChunker, text_embedder: TextEmbedder):
    ...
    def encode_text(self, file_path: Path) -> Optional[np.ndarray]:
        with open(file_path, 'r') as file_object:
            ...
            embeddings = self._vector_db_manager.insert_documents(text_chunks, embeddings)
        return embeddings
